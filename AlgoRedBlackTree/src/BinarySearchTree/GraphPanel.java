...
import BinarySearchTree.GraphPanel.BinarySearchTreeViewCapable.NodeConstants;
//import com.newviewer.GraphPanel.Kind;
import BinarySearchTree.RedBlackTree.Node;
import java.awt.event.*;
import java.util.ArrayList;
import java.util.List;
import java.util.ListIterator;
...
/*************************************************************************************************************************/
	...
	public class BinarySearchTreeViewCapable<T extends Comparable<T>> extends RedBlackTree<T> 
    {
    	...
    	{
    		Color nodeColour = (node.isRed) ? Color.red : Color.black;
